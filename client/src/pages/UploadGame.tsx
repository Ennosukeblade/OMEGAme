                        ...
                        <div className="max-w-md mx-auto">
                            ...
                            <div className="py-4 text-base leading-6 space-y-2 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <select className="border text-gray-600 text-sm rounded-md focus:ring-gray-500 focus:border-gray-900 block w-full p-2 border-gray-300 placeholder-gray-400">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <input type="number" className="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Leave it empty if free" />
                                </div>
                                <div className="flex flex-col">
                                    <label className="leading-loose">Upload:</label>
                                    <p className="text-sm pb-1">You can only upload a zipped file</p>
                                    <input type="file" accept=".zip,.rar" className="block w-full text-sm text-slate-500
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <textarea rows={4} className="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"></textarea>
                                </div>
